...
export default function TeamRegularSeasonPage({ params }: PageProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/coach-dashboard/regular-season")}>
            Retour aux équipes
          </Button>
        </div>
      </div>
        ...
        <div className="px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                onClick={() => router.push("/coach-dashboard/regular-season")}
              ...
              {currentSeason ? (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      onClick={() => router.push(`/coach-dashboard/regular-season/season/${currentSeason.id}`)}
                      className="flex items-center gap-2"
                    >
